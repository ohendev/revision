...
Movie.create(title: "Magnolia", preview: "An epic mosaic of many interrelated characters in search of happiness, forgiveness, and meaning in the San Fernando Valley.", poster_url: "https://www.themoviedb.org/t/p/w1280/lpqyJ156pg0fAME3qisXeC3iH5E.jpg", rating: 7.7)
Movie.create(title: "Schindler's List", preview: "The true story of how businessman Oskar Schindler saved over a thousand Jewish lives from the Nazis while they worked as slaves in his factory during World War II.", poster_url: "https://www.themoviedb.org/t/p/w1280/sF1U4EUQS8YHUYjNl3pMGNIQyr0.jpg", rating: 8.6)
